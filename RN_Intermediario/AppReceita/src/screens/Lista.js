    ...
    render () {
        return(
            <View style={styles.container}>
                <FlatList data={this.state.list} renderItem={({item}) => <Listagem data={item} onPress={() => this.props.navigation.navigate('Receita', {receita : item})}/>} />
            </View>
        );
    }
}
        ...
        return (
            <TouchableOpacity onPress={this.props.onPress} >
                <View style={styles.area}>
                    <Image source={{uri: this.props.data.imagem}} style={styles.image} resizeMode='contain'/>
